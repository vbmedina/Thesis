...
def extract_terms(description):
    ...
    strains = [strain for strain in lst_strains if (" " + strain + "(" in description)]
    ics = [ic for ic in lst_ic if (" " + ic + "(" in description)]
...
# test = " ".join(["D10","HB3","HB","HB-3","CDC/I/HB-3","7G8","JH6","XD8","KH7", "abcdefg"])
# print("Input: ", test)
# print()
# print("Output: ", extract_terms(test))
