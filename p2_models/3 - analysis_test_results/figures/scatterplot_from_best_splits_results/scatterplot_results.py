'''
Description: This script creates two-panel scatter plots of measured vs predicted pIC50 for selected split/fold runs,
...
def metrics_table_below(ax, hit, mcc_v, roc, rmse_v):
    cols = ["Hit rate at 100", "MCC", "ROC AUC", "RMSE"]
...
for split, fold in SELECTED:
    ...
    split_name = SPLIT_NAMES_GRAPH.get(split, split.replace("_", " "))
