...
# Load the data
data_path = "/Users/victoriamedina/Thesis_Project/Visualizations/strain_counts_viz.csv"
...
plt.savefig("/Users/victoriamedina/Thesis_Project/Visualizations/top_20_strains_histogram.png", dpi=300)
plt.show()

# Histogram of the top 20 chemicals ---------------------------------
# Load the data
data_path = "/Users/victoriamedina/Thesis_Project/Visualizations/chem_counts_viz.csv"
data = pd.read_csv(data_path)
...
# Save and show the plot
plt.savefig("/Users/victoriamedina/Thesis_Project/Visualizations/top_20_chemicals_histogram.png", dpi=300)
plt.show()
