...
# Path
df = pd.read_csv("./Thesis_Project/thesis/p0_all_csvs/chembl_data_original.csv", low_memory=False)
...
# Save path
save_path = "./Thesis_Project/thesis/p0_all_csvs/chembl_data_original.csv"
