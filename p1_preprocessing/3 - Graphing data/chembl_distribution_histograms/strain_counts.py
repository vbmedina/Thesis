...
csv_file_path = "./p1_preprocessing/3 - Graphing data/chembl_distribution_histograms/final_data_copy.csv"
...
output_csv_path = "./p1_preprocessing/3 - Graphing data/chembl_distribution_histograms/strain_counts.csv"
