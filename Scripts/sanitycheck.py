...
# Paths
chembl = pd.read_csv("/Users/victoriamedina/Thesis_Project/Thesis/Visualizations/chembl_unique.csv")
...
for i, row in chembl.iterrows():
    ...
    assay = row['Assay ChEMBL ID']
    alog = row['AlogP']
    smiles = row['Smiles']


    key = strain + chemical + str(ic50) + doc + assay 
...
copy_df.to_csv("/Users/victoriamedina/Thesis_Project/Thesis/Visualizations/duplicates_1.csv", index=False)
